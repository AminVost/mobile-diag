...
function HomeScreen({ navigation, route }) {
  // const [websocketStatus, setwebsocketStatus] = React.useState(route.params);
  const { websocketStatus, setWebsocketStatus } = useWebSocket();
  useEffect(() => {
    console.log('WebSocket connection status:', websocketStatus);
  }, [websocketStatus]);

  // React.useEffect(() => {
  //   console.log('HomeScreen websocketStatus: ', websocketStatus);
...
function StartApp({ route }) {
  const [websocketStatus, setwebsocketStatus] = React.useState(route.params.websocketConnected);
  React.useEffect(() => {
    setwebsocketStatus(route.params.websocketConnected);
    console.log('StartApp websocketStatus: ', websocketStatus);

  }, [route.params.websocketConnected]);
  return (
    <Drawer.Navigator initialRouteName="Home">
      <Drawer.Screen name="Home" component={HomeScreen} initialParams={{ websocketStatus }} options={{ headerShown: false }} />
