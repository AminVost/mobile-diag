  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.testTopBar}>
        ...
        <Text style={styles.testsStage}>1 / 40</Text>
        <Icon name={'close-circle-outline'} style={styles.closeIcon} onPress={() => navigation.navigate('HomeScreen')} />
      </View>

      <View style={styles.upperPart}>
        <Text style={styles.stepTitle}>
          Testing the device CPU
        </Text>
        <Icon name={'cpu-64-bit'} style={styles.testIcon} />
      </View>

      <View style={[styles.middlePart]}>
        <ScrollView style={[styles.middlePartTestsList]}>
          <View style={[styles.testCard]}>
            <Text style={styles.testTitle}>CPU model:</Text>
            <Text style={styles.testValue}>sdsajidhsa</Text>
          ...
          <View style={[styles.testCard]}>
            ...
            <View style={styles.cardRight}>
              {loading ? (
                ...
                <Avatar.Icon icon="check-bold" size={32} backgroundColor="green" />
              )}
            </View>
          </View>
          <View style={[styles.testCard]}>
            ...
            <View style={styles.cardRight}>
              {loading ? (
                ...
                <Avatar.Icon icon="close" size={32} backgroundColor="red" />
              )}
            </View>
          </View>
          <View style={[styles.testCard]}>
